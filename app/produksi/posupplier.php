                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="col card-header text-right">
                                ...
                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-addpo" disabled>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modalEditposupp-<?php echo $row['id_po_supp']; ?>" disabled><i class="fas fa-edit"></i></button>
