                                                                ...
                                                                <div class="tabbar padding_infor">
                                                                    <nav class="nav">
                                                                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                                                            ...
                                                                            <a class="nav-item nav-link" data-toggle="tab" href="#rek" aria-selected="false">Shearing Material</a>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <center>
                                                                                                    ...
                                                                                                    <?php } else { ?>
                                                                                                        <input type="button" class="btn btn-sm btn-success" value="Convert to Sheet" data-toggle="modal" data-target="#modalconvert<?php echo $row['id_mtl'] ?>" >
                                                                                                    <?php } ?>
