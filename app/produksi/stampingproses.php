...
if (isset($_POST['oui'])) {
    ...
    if ($prosess == 1) {
        ...
        if ($id_po != $po['id_po']) {
            ...
            $wip = mysqli_query($conn, "INSERT INTO proses1 (id_prs1,id_prs,id_cust,id_material,id_part,id_po,nama_proses,wip) VALUES ('','" . $id_prs['id_prs'] . "','$id_cust','$id_material','$id_part','$id_po','$proses1','" . $hasil['qty_po'] . "')");
            ...
            $pilih = mysqli_query($conn, "SELECT wip FROM proses1 where id_po='$id_po'");
            $pilihwip = mysqli_fetch_assoc($pilih);
            $query1 = mysqli_query($conn, "INSERT INTO proses1 (id_prs1,id_prs,id_cust,id_material,id_part,id_po,nama_proses,wip) VALUES ('','" . $id_prs['id_prs'] . "','$id_cust','$id_material','$id_part','$id_po','$proses1','" . $pilihwip['wip'] . "' ) ");
