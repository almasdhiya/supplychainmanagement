      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="../admin/datacustomer.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Data Customer</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="../admin/pocustomer.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Buat MRP</p>
              </a>
            </li>
        ...
        <li class="nav-item">
          <a href="../admin/mrp.php" class="nav-link">
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="../admin/datasupplier.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
                  Data Supplier
                </p>
            ...
            <li class="nav-item">
              <a href="../admin/posupplier.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
                  PO Supplier
                </p>
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="../admin/materialreq.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
                  Material Request
                </p>
            ...
            <li class="nav-item">
              <a href="../admin/materialrecipt.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
                  Material Recipt
                </p>
        ...
        <li class="nav-item">
          <a href="../admin/material.php" class="nav-link">
        ...
        <!-- <ul class="nav nav-treeview">
          ...
          <!-- <li class="nav-item">
              <a href="../admin/deliverynotesupp.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="../admin/stampingproses.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
                  Stamping Proses
                </p>
            ...
            <li class="nav-item">
              <a href="../admin/assemblyproses.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
                  Assembly Proses
                </p>
        ...
        <li class="nav-item">
          <a href="../admin/datafg.php" class="nav-link">
