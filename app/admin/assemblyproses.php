                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="tab_style1">
                                                                <div class="tabbar padding_infor">
                                                                    ...
                                                                    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modalcetak"><i class="fas fa-print mr-2"></i>CETAK LAPORAN SPOT 1</button>
                                                                    <br>
                                                                    <br>
                                                                            ...
                                                                            ?>
                                                                                <tr>
                                                                                    ...
                                                                                    <td><?php echo $row['qty_ng']; ?>
                                                                                        <p><button type="button" class="btn btn-sm  btn-dark" data-toggle="modal" data-target="#modalng1-<?php echo $row['id_spot1'] ?>"><i class="fas fa-external-link-alt"></i></button></p>
                                                                                    </td>
                                                                                    <td><?php echo $row['tgl']; ?></td>
                                                                                    <td>
                                                                                        <center>
                                                                                            <button type="button" class="btn btn-md btn-success" data-toggle="modal" data-target="#modalspot1-<?php echo $row['id_spot1'] ?>"><i class="far fa-plus-square"></i></button>
                                                                                            ...
                                                                                            <?php } else { ?>
                                                                                                <button type="button" class="btn btn-md btn-primary" data-toggle="modal" data-target="#modalsv1-<?php echo $row['id_spot1'] ?>"><i class="fas fa-save"></i></button>
                                                                                            <?php } ?>
