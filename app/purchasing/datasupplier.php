                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <center>
                                                        <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modal-<?php echo $supp['id_supp']; ?>"><i class="fas fa-edit"></i></button>
                                                        <a onclick="hapussupp(<?php echo $supp['id_supp']; ?>)" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                                    </center>
                                                </td>
                                            </tr>
                                            <!-- MODAL EDIT supp -->
