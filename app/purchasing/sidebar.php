  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="../purchasing/index.php" class="nav-link">
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="../purchasing/datacustomer.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Data Customer</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="../purchasing/pocustomer.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Buat MRP</p>
              </a>
            </li>
        ...
        <li class="nav-item">
          <a href="../purchasing/mrp.php" class="nav-link">
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="../purchasing/datasupplier.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
                  Data Supplier
                </p>
            ...
            <li class="nav-item">
              <a href="../purchasing/posupplier.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
                  PO Supplier
                </p>
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="../purchasing/materialreq.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
                  Material Request
                </p>
            ...
            <li class="nav-item">
              <a href="../purchasing/materialrecipt.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
                  Material Recipt
                </p>
        ...
        <li class="nav-item">
          <a href="../purchasing/material.php" class="nav-link">
        ...
        <!-- <ul class="nav nav-treeview">
          ...
          <!-- <li class="nav-item">
              <a href="../purchasing/deliverynotesupp.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="../purchasing/stampingproses.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
                  Stamping Proses
                </p>
            ...
            <li class="nav-item">
              <a href="../purchasing/assemblyproses.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
                  Assembly Proses
                </p>
        ...
        <li class="nav-item">
          <a href="../purchasing/datafg.php" class="nav-link">
        ...
        <li class="nav-item">
          <a href="../purchasing/delivery.php" class="nav-link">
