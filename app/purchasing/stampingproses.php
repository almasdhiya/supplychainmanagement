                                                                    ...
                                                                    <div class="tab-content" id="nav-tabContent">
                                                                        <div class="tab-pane fade show active" id="proses1" role="tabpanel" aria-labelledby="nav-home-tab">
                                                                            <div class="text-right">
                                                                                <p><button type="button" class="btn btn-success" data-toggle="modal" data-target="#modaltambah" disabled><i class="fas fa-plus mr-2"></i>Tambah Proses Produksi</button></p>
                                                                            </div>
                                                                            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modalcetak" disabled><i class="fas fa-print mr-2"></i>CETAK LAPORAN PROSES 1</button>
                                                                            <br>
                                                                            <br>
                                                                                    ...
                                                                                    ?>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td><?php echo $row['qty_ng']; ?>
                                                                                                <p> <button type="button" class="btn btn-sm btn-dark" data-toggle="modal" data-target="#modalng-<?php echo $row['id_prs1'] ?>" disabled><i class="fas fa-external-link-alt"></i></button>
                                                                                                </p>
                                                                                            </td>
                                                                                            <td><?php echo $row['tgl']; ?></td>
                                                                                            <td>
                                                                                                <center>
                                                                                                    <pre><button type="button" class="btn btn-md btn-success" data-toggle="modal" data-target="#modalprs1-<?php echo $row['id_prs1'] ?>" disabled><i class="far fa-plus-square"></i></button></pre>
                                                                        ...
                                                                        <div class="tab-pane fade show" id="proses2" role="tabpanel" aria-labelledby="nav-home-tab">
                                                                            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modalcetak2" disabled><i class="fas fa-print mr-2"></i>CETAK PROSES 2</button>
                                                                            <br>
                                                                            <br>
                                                                                    ...
                                                                                    ?>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td><?php echo $row['qty_ngg']; ?>
                                                                                                <p><button type="button" class="btn btn-sm  btn-dark" data-toggle="modal" data-target="#modalng2-<?php echo $row['id_prs2'] ?>" disabled><i class="fas fa-external-link-alt"></i></button></p>
                                                                                            </td>
                                                                                            <td><?php echo $row['tgl']; ?></td>

                                                                                            <td>
                                                                                                <center>
                                                                                                    <button type="button" class="btn btn-md btn-success" data-toggle="modal" data-target="#modalprs2-<?php echo $row['id_prs2'] ?>" disabled><i class="far fa-plus-square"></i></button>
                                                                                                    <?php if ($row['kondisi'] ==  'Sudah Digunakan') { ?>
                                                                        ...
                                                                        <div class="tab-pane fade show" id="proses3" role="tabpanel" aria-labelledby="nav-home-tab">
                                                                            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modalcetak3" disabled><i class="fas fa-print mr-2"></i>CETAK PROSES 3</button>
                                                                            <br>
                                                                            <br>
                                                                                    ...
                                                                                    ?>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td><?php echo $row['qty_nggg']; ?>
                                                                                                <p><button type="button" class="btn btn-sm  btn-dark" data-toggle="modal" data-target="#modalng3-<?php echo $row['id_prs3'] ?>" disabled><i class="fas fa-external-link-alt"></i></button></p>
                                                                                            </td>
                                                                                            <td><?php echo $row['tgl']; ?></td>
                                                                                            <td>
                                                                                                <center>
                                                                                                    <button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#modalprs3-<?php echo $row['id_prs3'] ?>" disabled><i class="far fa-plus-square"></i></button>
                                                                                                    <?php if ($row['kondisi'] ==  'Sudah Digunakan') { ?>
                                                                        ...
                                                                        <div class="tab-pane fade show" id="proses4" role="tabpanel" aria-labelledby="nav-home-tab">
                                                                            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modalcetak4" disabled><i class="fas fa-print mr-2"></i>CETAK PROSES 4</button>
                                                                            <br>
                                                                            <br>
                                                                                    ...
                                                                                    ?>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td><?php echo $row['qty_ngggg']; ?>
                                                                                                <p> <button type="button" class="btn btn-sm btn-dark" data-toggle="modal" data-target="#modalng4-<?php echo $row['id_prs4'] ?>" disabled><i class="fas fa-external-link-alt"></i></button></p>
                                                                                            </td>
                                                                                            <td><?php echo $row['tgl']; ?></td>
                                                                                            <td>
                                                                                                <center>
                                                                                                    <button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#modalprs4-<?php echo $row['id_prs4'] ?>" disabled><i class="far fa-plus-square"></i></button>
                                                                                                    <?php if ($row['kondisi'] ==  'Sudah Digunakan') { ?>
                                                                        ...
                                                                        <div class="tab-pane fade show" id="proses5" role="tabpanel" aria-labelledby="nav-home-tab">
                                                                            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modalcetak5"><i class="fas fa-print mr-2" disabled></i>CETAK PROSES 5</button>
                                                                            <br>
                                                                            <br>
                                                                                    ...
                                                                                    ?>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td><?php echo $row['qty_nggggg']; ?>
                                                                                                <p> <button type="button" class="btn btn-sm btn-dark" data-toggle="modal" data-target="#modalng5-<?php echo $row['id_prs5'] ?>" disabled><i class="fas fa-external-link-alt"></i></button></p>
                                                                                            </td>
                                                                                            <td><?php echo $row['tgl']; ?></td>
                                                                                            <td>
                                                                                                <center>
                                                                                                    <button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#modalprs5-<?php echo $row['id_prs5'] ?>" disabled><i class="far fa-plus-square"></i></button>
                                                                                                    <?php if ($row['kondisi'] ==  'Sudah Digunakan') { ?>
                                                                        ...
                                                                        <div class="tab-pane fade show" id="proses6" role="tabpanel" aria-labelledby="nav-home-tab">
                                                                            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modalcetak6" disabled><i class="fas fa-print mr-2"></i>CETAK PROSES 6</button>
                                                                            <br>
                                                                            <br>
                                                                                    ...
                                                                                    ?>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td><?php echo $row['qty_ngggggg']; ?>
                                                                                                <p> <button type="button" class="btn btn-sm btn-dark" data-toggle="modal" data-target="#modalng6-<?php echo $row['id_prs6'] ?>" disabled><i class="fas fa-external-link-alt"></i></button></p>
                                                                                            </td>
                                                                                            <td><?php echo $row['tgl']; ?></td>
                                                                                            <td>
                                                                                                <center>
                                                                                                    <button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#modalprs6-<?php echo $row['id_prs6'] ?>" disabled><i class="far fa-plus-square"></i></button>
                                                                                                    <?php if ($row['kondisi'] ==  'Sudah Digunakan') { ?>
                                                                        ...
                                                                        <div class="tab-pane fade show" id="proses7" role="tabpanel" aria-labelledby="nav-home-tab">
                                                                            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modalcetak7" disabled><i class="fas fa-print mr-2"></i>CETAK PROSES 7</button>
                                                                            <br>
                                                                            <br>
                                                                                    ...
                                                                                    ?>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td><?php echo $row['qty_nggggggg']; ?>
                                                                                                <p><button type="button" class="btn btn-sm btn-dark" data-toggle="modal" data-target="#modalng7-<?php echo $row['id_prs7'] ?>" disabled><i class="fas fa-external-link-alt"></i></button></p>
                                                                                            </td>
                                                                                            <td><?php echo $row['tgl']; ?></td>
                                                                                            <td>
                                                                                                <center>
                                                                                                    <button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#modalprs7-<?php echo $row['id_prs7'] ?>" disabled><i class="far fa-plus-square"></i></button>
                                                                                                    <?php if ($row['kondisi'] ==  'Sudah Digunakan') { ?>
