<!-- Navbar -->
<meta http-equiv="refresh" content="1800; url=../app/login.php">
<?php
include('../koneksi.php');
// include ('header.php');
?>
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="pocustomer.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>PO Customer</p>
              </a>
            </li>
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="posupplier.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
                  PO Supplier
                </p>
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="materialreq.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
                  Material Request
                </p>
            ...
            <li class="nav-item">
              <a href="materialrecipt.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
                  Material Recipt
                </p>
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              ...
              <!-- <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="lembar.php" class="nav-link">
                ...
                <li class="nav-item">
                  <a href="sheet.php" class="nav-link">
                    <p style="text-indent: 30px;">
                      <i class="fas fa-circle"></i>
                      Sheet
                    </p>
                ...
                <li class="nav-item">
                  <a href="coil.php" class="nav-link">
                    <p style="text-indent: 30px;">
                      <i class="fas fa-circle"></i>Coil
                    </p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="pieces.php" class="nav-link">
                    <p style="text-indent: 30px;">
                      <i class="fas fa-circle"></i>Pieces
                    </p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="tube.php" class="nav-link">
                    <p style="text-indent: 30px;">
                      <i class="fas fa-circle"></i>Tube
                    </p>
                  </a>
                </li>
              </ul> -->
            ...
            <li class="nav-item">
              <a href="deliverynotesupp.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="stampingproses.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
                  Stamping Proses
                </p>
            ...
            <li class="nav-item">
              <a href="assemblyproses.php" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
                <p>
                  Assembly Proses
                </p>
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="subcont.php" class="nav-link disabled">
              <i class="far fa-circle nav-icon"></i>
                <p>
                  Subcont
                </p>
            ...
            <li class="nav-item">
              <a href="datafg.php" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
                <p>
                  Data Finish Good
                </p>
