  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="../ppic/index.php" class="nav-link">
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="../ppic/datacustomer.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Data Customer</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="../ppic/pocustomer.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Buat MRP</p>
              </a>
            </li>
        ...
        <li class="nav-item">
          <a href="../ppic/mrp.php" class="nav-link">
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="../ppic/datasupplier.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
                  Data Supplier
                </p>
            ...
            <li class="nav-item">
              <a href="../ppic/posupplier.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
                  PO Supplier
                </p>
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="../ppic/materialreq.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
                  Material Request
                </p>
            ...
            <li class="nav-item">
              <a href="../ppic/materialrecipt.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
                  Material Recipt
                </p>
        ...
        <li class="nav-item">
          <a href="../ppic/material.php" class="nav-link">
        ...
        <!-- <ul class="nav nav-treeview">
          ...
          <!-- <li class="nav-item">
              <a href="../ppic/deliverynotesupp.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="../ppic/stampingproses.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
                  Stamping Proses
                </p>
            ...
            <li class="nav-item">
              <a href="../ppic/assemblyproses.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
                  Assembly Proses
                </p>
        ...
        <li class="nav-item">
          <a href="../ppic/datafg.php" class="nav-link">
        ...
        <li class="nav-item">
          <a href="../ppic/delivery.php" class="nav-link">
