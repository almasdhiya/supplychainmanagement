                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modalEdit-<?php echo $row['id_part']; ?>"><i class="fas fa-edit"></i></button>
                                                    <a onclick="hapuspart(<?php echo $row['id_part']; ?>,<?php echo $row['id_cust']; ?>)" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                                </td>
                                                <!-- <td align="center">
