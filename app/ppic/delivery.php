                                                                ...
                                                                <div class="tabbar padding_infor">
                                                                    ...
                                                                    <div class="tab-content" id="nav-tabContent">
                                                                                ...
                                                                                <form method="post" action="">
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <div class="row">
                                                                                            <div class="col-3">
                                                                                                <label></label>
                                                                                                <button type="submit" name="kk" class="btn btn-md btn-success" disabled> Submit Delivery </button>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </form>
                                                                        ...
                                                                        <div class="tab-pane fade" id="rek" role="tabpanel" aria-labelledby="nav-home-tab">
                                                                            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modalcetak" disabled><i class="fas fa-print mr-2"></i>CETAK</button>
                                                                            <br>
                                                                            <br>
