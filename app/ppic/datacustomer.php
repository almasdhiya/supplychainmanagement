                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <center>
                                                            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modal-<?php echo $cust['id_cust']; ?>"><i class="fas fa-edit"></i></button>
                                                            <a onclick="hapuscust(<?php echo $cust['id_cust']; ?>)" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                                        </center>
                                                    </td>
                                                </tr>
                                                <!-- MODAL EDIT cust -->
