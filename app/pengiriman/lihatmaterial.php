...
if (isset($_POST['edit'])) {
    ...
    spek_material='$spek_material',ketebalan='$ketebalan',lebar='$lebar',panjang='$panjang'
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modalEdit-<?php echo $row['id_material']; ?>"disabled><i class="fas fa-edit"></i></button>
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="row">
                                                                        <div class="col-3">
                                                                            ...
                                                                            <input type="text" class="form-control" id="nama_cust" name="nama_supp" value="<?php echo $row['nama_supp']; ?>" readonly>
                                                                        </div>
                                                                        <div class="col-3">
