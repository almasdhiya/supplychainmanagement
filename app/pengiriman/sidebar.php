      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="../pengiriman/datacustomer.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Data Customer</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="../pengiriman/pocustomer.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Buat MRP</p>
              </a>
            </li>
        ...
        <li class="nav-item">
          <a href="../pengiriman/mrp.php" class="nav-link">
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="../pengiriman/datasupplier.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
                  Data Supplier
                </p>
            ...
            <li class="nav-item">
              <a href="../pengiriman/posupplier.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
                  PO Supplier
                </p>
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="../pengiriman/materialreq.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
                  Material Request
                </p>
            ...
            <li class="nav-item">
              <a href="../pengiriman/materialrecipt.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
                  Material Recipt
                </p>
        ...
        <li class="nav-item">
          <a href="../pengiriman/material.php" class="nav-link">
        ...
        <!-- <ul class="nav nav-treeview">
          ...
          <!-- <li class="nav-item">
              <a href="../pengiriman/deliverynotesupp.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="../pengiriman/stampingproses.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
                  Stamping Proses
                </p>
            ...
            <li class="nav-item">
              <a href="../pengiriman/assemblyproses.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>
                  Assembly Proses
                </p>
        ...
        <li class="nav-item">
          <a href="../pengiriman/datafg.php" class="nav-link">
        ...
        <li class="nav-item">
          <a href="../pengiriman/delivery.php" class="nav-link">
